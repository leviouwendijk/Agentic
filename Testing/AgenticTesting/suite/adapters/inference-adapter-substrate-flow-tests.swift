...
enum InferenceAdapterSubstrateFlowTests {
    ...
    static func adaptationDiagnostics() throws -> [TestDiagnostic] {
        let adaptation = InferenceAdaptation(
    ...
    static func catalogDiagnostics() throws -> [TestDiagnostic] {
        ...
        } catch let error as InferenceAdapterCatalogError {
            switch error {
...
private struct ProbeInferenceAdapter: InferenceAdapter {
