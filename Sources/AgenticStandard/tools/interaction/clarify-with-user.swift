...
@JSONSchema
public struct ClarifyWithUserInput: Sendable, Codable, Hashable {
...
@JSONSchema
public struct ClarifyWithUserOutput: Sendable, Codable, Hashable {
...
public struct ClarifyWithUser: Tool {
    public typealias Input = ClarifyWithUserInput
    public typealias Output = ClarifyWithUserOutput
